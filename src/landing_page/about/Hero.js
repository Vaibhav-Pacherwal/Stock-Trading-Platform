...
export default function Hero() {
    return (
        <div className="container">
            ...
            <div className="row p-5 mt-5 mb-5 border-top text-muted fs-5">
                ...
                <div className="col p-5">
                    ...
                    <p>
                        <Link to="/rainmatter">Rainmatter</Link>, our fintech fund and incubator, has invested in several fintech 
                        startups with the goal of growing the Indian capital markets.
                    </p>
                    <p>
                        And yet, we are always up to something new every day. Catch up on the latest 
                        updates on our <Link to="/blog">blog</Link> or see what the media is <Link to="/sayaboutus">saying about us</Link> or learn more about 
                        our business and product <Link to="/philosophies">philosophies</Link>.
                    </p>
                </div>
            </div>
        </div>

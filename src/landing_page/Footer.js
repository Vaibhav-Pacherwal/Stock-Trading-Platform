        ...
        <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
            <div className="container border-top pt-3">
                <div className="row mb-5 mt-5">
                    <div className="col">
                        <img src="media/images/logo.svg" className="mb-4 text-muted" style={{ width: "50%" }} />
                        <p>
                            © 2010 - 2025, Zerodha Broking Ltd.
                            All rights reserved.
                        </p>
                        <div>
                            <a href="" style={{ textDecoration: "none", fontSize: "20px" }} className="text-muted mx-1"><i class="fa-brands fa-twitter"></i></a>
                            <a href="" style={{ textDecoration: "none", fontSize: "20px" }} className="text-muted mx-1"><i class="fa-brands fa-square-facebook"></i></a>
                            <a href="" style={{ textDecoration: "none", fontSize: "20px" }} className="text-muted mx-1"><i class="fa-brands fa-instagram"></i></a>
                            <a href="" style={{ textDecoration: "none", fontSize: "20px" }} className="text-muted mx-1"><i class="fa-brands fa-linkedin-in"></i></a>
                            <a href="" style={{ textDecoration: "none", fontSize: "20px" }} className="text-muted mx-1"><i class="fa-brands fa-telegram"></i></a>
                        </div>
                    </div>
                    <div className="col">
                ...
                <p className="text-muted" style={{ fontSize: "14px" }}>
                    ...
                    please write to complaints@zerodha.com, for DP related to dp@zerodha.com. Please ensure
                ...
                <p className="text-muted" style={{ fontSize: "14px" }}>
                    ...
                    subscribing to an IPO, there is no need to issue a cheque. Please write the
                    Bank account number and sign the IPO application form to authorize your bank to make
                    payment in case of allotment. In case of non allotment the funds will remain in your
                    bank account. As a business we don't give stock tips, and have not authorized anyone
